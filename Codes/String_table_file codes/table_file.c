...
int create_row(char* filename, char* stringname){ // Time complexity = O(R + C), R is no of rows, C is no of columns
    char*index_suffix = "_index.txt";
    size_t index_file_len = strlen(filename)+strlen(index_suffix)+1;
    char* index_filename = malloc(index_file_len);
    if(index_filename==NULL){
...
int create_column(char* filename, char* stringname){ // Time complexity = O(R + C), R is no of rows, C is no of columns
    char*index_suffix = "_index.txt";
    size_t index_file_len = strlen(filename)+strlen(index_suffix)+1;
    char* index_filename = malloc(index_file_len);
    if(index_filename==NULL){
...
int delete_row(char *filename,char* stringname){ // Time complexity = O(R + C), R is no of rows, C is no of columns
    char*index_suffix = "_index.txt";
    size_t index_file_len = strlen(filename)+strlen(index_suffix)+1;
    char* index_filename = malloc(index_file_len);
    if(index_filename==NULL){
...
int delete_column(char *filename,char* stringname){ // Time complexity = O(R + C), R is no of rows, C is no of columns
    char*index_suffix = "_index.txt";
    size_t index_file_len = strlen(filename)+strlen(index_suffix)+1;
    char* index_filename = malloc(index_file_len);
    if(index_filename==NULL){
